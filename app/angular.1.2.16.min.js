...
(function(O, U, s) {
    ...
    function se(b, a, c, d) {
        ...
        h.url = function(a, c) {
            ...
            if (a) {
                if (J != a)
                    return J = a, d.history ? c ? m.replaceState(null, "", a) : (m.pushState(null, "",
        ...
        h.cookies = function(a, b) {
            var d, e, g, h;
            if (a)
                b === s ? l.cookie = escape(a) + "=;path=" + H + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" :
            ...
            "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function(a, b, m, n, p, r, z, u, F, v, J, A) {
                ...
                function ia(a, c, d, e, g, f, l, n, p) {
                    ...
                    for (var v = -Number.MAX_VALUE, A, L = p.controllerDirectives, Q = p.newIsolateScopeDirective,
                        ...
                        if (V = G.transclude)
                            E = !0, G.$$tlb || (K("transclusion", T, G, Z), T = G), "element" == V ? (D = !0, v = G.priority,
                        ...
                        if (G.template)
                            if (K("template", ia, G, Z), ia = G, V = P(G.template) ? G.template(Z, d) : G.template, V = Y(V), G.replace) {
                                ...
                                Z.html(V);
                        if (G.templateUrl)
                            K("template", ia, G, Z), ia = G, G.replace && (f = G), J = C(a.splice(N, a.length - N), Z, d, g, Xa, l, n, {controllerDirectives: L, newIsolateScopeDirective: Q, templateDirective: ia, nonTlbTranscludeDirective: T}), S = a.length;
                        else if (G.compile)
                            try {
        ...
        this.$get = ["$parse", "$exceptionHandler", "$sce", function(c, d, e) {
                function g(g, k, m) {
                    for (var n, p, r = 0, z = [], u = g.length, F = !1, v = []; r < u; )
                        -1 != (n = g.indexOf(b, r)) && -1 != (p = g.indexOf(a, n + f)) ? (r != n && z.push(g.substring(r, n)), z.push(r = c(F = g.substring(n + f, p))),
    ...
    var sd = ["$animate", function(a) {
            ...
            return{restrict: "ECA", priority: 400, terminal: !0, transclude: "element", controller: Ea.noop, compile: function(f,
                        h) {
        ...
        link: function(a, c, d, e, g) {
            ...
            return{restrict: "E", terminal: !0, compile: function(c,
                        d) {
                        ...
                        function h() {
                            ...
                            for (E = c.length; I < E; I++) {
                                ...
                                for (F = k.length; A < F; A++)
                                    s = k[A], (d = z[A + 1]) ? (D = d.element, d.label !== s.label &&
